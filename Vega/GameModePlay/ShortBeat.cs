...
namespace Vega.GameModePlay
{
    public class ShortBeat : Beat
    {
        ...
        private static Vector2 BeatOrigin = new Vector2(23.0f, 0.0f);
        public override void Draw(double t0, double t1)
        {
            ...
            Assets.BlueBeatMid.Draw(x, y1, 50.0f, y1 - y0, BeatOrigin, Color4.White);
            Assets.BlueBeat.Draw(x, y0, 50.0f, y0, BeatOrigin, Color4.White);
            Assets.BlueBeat.Draw(x, y1, 50.0f, y0, BeatOrigin, Color4.White);
        }
